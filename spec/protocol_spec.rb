...
describe Chat::Protocol do
  describe '.validate message' do
    context 'from Client or Server' do
      context 'and when it has' do
        context "'nil'" do
          let(:nil_msg) { nil }
        ...
        context 'an incorrect :source' do
    ...
    context 'from Client' do
      context 'and when it is correct' do
      ...
      context 'and when it has' do
        context 'an incorrect :command' do
        ...
        context 'an incorrect :params' do
    ...
    context 'from Server' do
      ...
      context 'and when it has' do
        ...
        context 'an incorrect :params 2' do
